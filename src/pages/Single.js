        ...
        <div class="content-area">
          <div class="page-title">
            <div
              class="main-top"
              style={{
                backgroundImage: "url(assets/images/bg-page-title-04.jpg)",
              }}
            >
              <div class="overlay-top-header"></div>

              <div class="content container">
                <h1>Modern warfare (2018)</h1>

                <div class="description">
                  To start the day in the best way, enjoythe extraordinary
                  buffetbreakfast in the our courtyard caressed
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div class="player-video">
                        <div class="bg-video">
                          <iframe
                            ...
                            width="100%"
                            height="660px"
                            src="https://www.youtube.com/embed/hNQFjqDvPhA"
                          ></iframe>
                        </div>

                        {/*} <a href="https://www.youtube.com/watch?v=NEqtQYxzQaE" class="btn-play"></a> */}
                      </div>
                      ...
                      <div class="detail-video">
                        <div class="info-detail sticky-sidebar">
                          <div class="inner-info">
                            ...
                            <div class="info-video">
                              <div class="item-info">
                                <span class="name-item">Actors:</span>

                                <span class="value-item">Julia Toufis</span>
                              </div>

                              <div class="item-info">
                                <span class="name-item">Writer:</span>

                                <span class="value-item">Noah</span>
                              </div>

                              <div class="item-info">
                                <span class="name-item">Release Date:</span>

                                <span class="value-item">May 12, 2018</span>
                              </div>

                              <div class="item-info">
                                <span class="name-item">Genres:</span>
                              ...
                              <div class="item-info">
                                ...
                                <span class="value-item">USA</span>
                              </div>

                              <div class="item-info">
                                <span class="name-item">Runtime:</span>

                                <span class="value-item">60 min</span>
                              </div>

                              <div class="item-info">
                                <span class="name-item">Language:</span>

                                <span class="value-item">English</span>
                              </div>

                              <div class="item-info">
                                <span class="name-item">Type:</span>

                                <span class="value-item">Short</span>
                              </div>
                            </div>
                        ...
                        <div class="content-detail">
                          <div class="field-detail">
                            <h3 class="title-field">Movie Story</h3>
                            ...
                            <div class="content-field">
                              ...
                              <p>
                                ...
                                aspernatur aut odit aut fugit, sed quia magni
                          ...
                          <div class="field-detail">
                            <h3 class="title-field">Video & Photo</h3>
                              ...
                              >
                                ...
                                <div class="slide-slick">
                                  <div class="item-slick">
                                    <div class="item-img">
                                      <img
                                        src="assets/images/video-detail-02.jpg"
                                        alt="IMG"
                                      />
                                    </div>
                                  </div>
                          ...
                          <div class="author-blog">
                            ...
                            <div class="text-author">
                              <div class="name-author">
                                <a href="javascript:;">Michael Mikado</a>
                              </div>

                              <div class="info-aothor">Front-end dev</div>

                              <div class="content-author">
                                If you are a newbie to managing a WordPress
                                website, then tions! You are here at the right
                                track with us be we are going to introduce you
                                one of the most basic knowledge when owning a
                                WordPress page: how to find your site
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="navigate-blog">
                            <div class="navi-item prev-blog">
                              ...
                              <div class="navi-text">
                                ...
                                <div class="info-navi">October 15, 2018</div>
                              </div>
                            </div>
                                      ...
                                      <div class="post-item">
                                        ...
                                        <h4 class="title">
                                          <a href="single-video.html">
                                            How To Make a Pimple Disappear With
                                            Makeup
                                          </a>
                                        </h4>
                                      </div>
